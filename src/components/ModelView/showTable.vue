<template>
    <div class="container">
        <div class="date_class" :class="{ date_temp: isTimeChecked }">
            <el-checkbox class="checked_class" v-model="isTimeChecked"> <span class="span_word">日期</span></el-checkbox>
            <div class="demo-date-picker" style="display: inline; padding: 5px 5px 5px 0px">
                <el-date-picker style="width: 160px" v-model="startDay" type="date" format="YYYY/MM/DD" value-format="YYYY-MM-DD">
            ...
            <div class="demo-date-picker" style="display: inline; padding: 5px 5px 5px 54px">
                <el-date-picker style="width: 160px" v-model="endDay" type="date" format="YYYY/MM/DD" value-format="YYYY-MM-DD">
                    <template #default="cell">
                        <div class="cell" :class="{ current: cell.isCurrent }">
                            <span class="text">{{ cell.text }}</span>
                        </div>
        ...
        <div class="serial_calss">
            <el-checkbox v-model="isSerialChecked" @change="serialChange"> <span class="span_word">产品序列</span></el-checkbox>
        ...
        <div class="btn_class">
            ...
            <el-button class="export_class" @click="exportDataBtn(tableName)" :disabled="disbtn" type="primary">导出</el-button>

            <!-- <el-button style="margin-top: 7px; margin-left: 15px; height: 60px; width: 120px" @click="expotArrayTest()" type="primary"
                >导出测试</el-button
            > -->
        </div>
    </div>
...
<script setup>
    import { ref, watchEffect, reactive, defineProps, shallowRef, computed, onMounted, onBeforeUnmount } from "vue";
    import { getSeleName } from "@/service/GetDataMethod/getTaleColName";
    import { realList, startExport, pagerConfig, getPageData, alertMess } from "@/service/GetDataMethod/utils";
